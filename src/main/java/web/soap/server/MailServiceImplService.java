 ...
 * 
 */
@WebServiceClient(name = "MailServiceImplService", targetNamespace = "http://server.soap.web/", wsdlLocation = "http://localhost:8080/OlehFedorivService/MailService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MAILSERVICEIMPLSERVICE_QNAME = new QName("http://server.soap.web/", "MailServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/OlehFedorivService/MailService?wsdl");
    ...
    public MailService getMailServiceImplPort() {
        return super.getPort(new QName("http://server.soap.web/", "MailServiceImplPort"), MailService.class);
    }
    ...
    public MailService getMailServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.soap.web/", "MailServiceImplPort"), MailService.class, features);
    }
